...
(function() {
  ...
  require(['jquery', 'backbone', "Helper", 'bootstrap', 'simplePagination'], function($, Backbone, Helper) {
    return $(function() {
      ...
      fetchFromSina = function(cIndex) {
        ...
        return $.ajax({
          ...
          success: function(data) {
            ...
            $.each(data.label, function(idx) {
              return $('<span>' + data.label[idx] + '&nbsp;</span>').addClass('ulabel').appendTo("#userlabel");
            });
            $("#geo").text(data.geo);
            $("#edu").text(data.edu);
            $("#weiboContent").html('');
            $.each(data.weiboContent, function(idx) {
              return $(data.weiboContent[idx]).appendTo("#weiboContent");
            });
      ...
      return $("#btn_save_result").click(function(e) {
